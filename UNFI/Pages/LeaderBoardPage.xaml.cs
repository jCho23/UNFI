    ...
    public partial class LeaderBoardPage : ContentPage
    {
        public LeaderBoardPage()
        {
            ...
            leaderBoardListView.ItemsSource = new List<LeaderBoardModel>{
                ...
                new LeaderBoardModel {Rank = "2", Points= "230", TeamName = "Jordan", PictureUrl = "https://www.pixelstalk.net/wp-content/uploads/2015/12/Air-Jordan-Logo-wallpapers-620x465.jpg"},
